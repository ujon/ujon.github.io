...
무선 통신을 통해 차량 소프트웨어/펌웨어를 원격으로 업데이트하거나 패치하는 기술.  
서비스센터 방문 없이도 기능 개선, 보안 패치, 신규 서비스 추가가 가능하여 차량의 **지속적 성능 향상 및 유지보수 비용 절감**에 기여함.  
자율주행차, 커넥티드카 환경에서 핵심적인 요소.

도메인: `mobility`

관련단어: [OBD (On-Board Diagnostics)](#obd-on-board-diagnostics)
